    ...
    const fifteenHundreds = inventors.filter(function (inventor) {
      if (inventor.year >= 1500 && inventor.year < 1600) {
        return true; // By returning true it means we keep it.
      };
    });
    ...
    // 2. Give us an array of the inventors' first and last names
      ...
      //His solution using concatinating stings (ES6)
    ...
    // 4. How many years did all the inventors live?
      ...
      // His Solution. Not to sure how this one worked
    ...
    // https://en.wikipedia.org/wiki/Category:Boulevards_in_Paris
      ...
      // His solution
      // First you must look at the HTML doc (dev tools) and find what you need to select.
        // const category = document.querySelector('.mw-category');

      // You can call querySelector against any existing DOM element.
      // You also need to turn the links variable into an array so .map is accessable in devtools.
